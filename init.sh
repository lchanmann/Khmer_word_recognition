...
mkdir -p models models/hmm_0 models/hmm_2
...
#  -T 1 -H models/hmm_0/models.mmf -M models/hmm_0 \
#  -C configs/herest.conf -w 1 -t 120.0 60.0 960.0 \
#  -S scp/khmer.scp -I mlf/khmer.mlf phe/khmer.phe \
...
#  -S scp/khmer.scp -H models/hmm_0/models.mmf dct/khmer.dct.withsil phe/khmer.phe \
#  > models/hmm_0/hvite.log
